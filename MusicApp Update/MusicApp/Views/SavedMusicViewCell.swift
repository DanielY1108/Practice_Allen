...
final class SavedMusicViewCell: UITableViewCell {
    
    static var Identifier = "MyListCell"
    ...
    var saveButtonTapped: ((SavedMusicViewCell) -> Void)?
    ...
    func configureData() {
        ...
        mainImageView.loadFrom(URLAddress: musicSaved.artworkUrl100)
        trackNameLabel.text = musicSaved.trackName
        artistNameLabel.text = musicSaved.artistName
        albumLabel.text = musicSaved.collectionName
        releaseDateLabel.text = musicSaved.releaseDate
        genreLabel.text = musicSaved.genreName
        messegeLable.text = "Saved Date:  \(musicSaved.myMessege ?? "")"
        setButtonStatus()
    }
    ...
    func setupCell() {
        ...
        self.contentView.addSubview(messegeLable)
    ...
    func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            messegeLable.topAnchor.constraint(equalTo: stackViewPart2.bottomAnchor),
            messegeLable.heightAnchor.constraint(greaterThanOrEqualToConstant: 1),
            messegeLable.leadingAnchor.constraint(equalTo: self.leadingAnchor),
            messegeLable.trailingAnchor.constraint(equalTo: self.trailingAnchor),
        ])
