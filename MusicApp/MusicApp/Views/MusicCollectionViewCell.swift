...
//  MusicApp
//
//  Created by JinSeok Yang on 2022/10/09.
//
...
class MusicCollectionViewCell: UICollectionViewCell {
    ...
    private func loadImage() {
        guard let urlString = self.musicImage, let url = URL(string: urlString)  else { return }
        ...
        DispatchQueue.global().async {
            ...
            guard self.musicImage! == url.absoluteString else { return }
